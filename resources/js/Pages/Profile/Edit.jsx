                    ...
                    <div className="rounded-2xl bg-white p-6 shadow-sm dark:bg-[#1e2126] sm:p-8">
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <div className="flex items-center gap-2">
                                        <h2 className="text-lg font-semibold text-[#293951] dark:text-white">
                            ...
                            <div className="flex flex-wrap items-center gap-3">
                                ...
                                <div className="flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50/50 px-4 py-2.5 dark:border-gray-800/40 dark:bg-[#181b1f]">
                                    <ShieldCheck className="h-4 w-4 text-[#95aac9] dark:text-[#a7a6a8]" />
                                    <div className="text-xs">
                                        <span className="block text-[#95aac9] dark:text-[#a7a6a8]">Estado de Acceso:</span>
                                ...
                                {/* Telemetry Indicator */}
                                <div className="flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50/50 px-4 py-2.5 dark:border-gray-800/40 dark:bg-[#181b1f]">
                                    <Activity className="h-4 w-4 text-[#95aac9] dark:text-[#a7a6a8]" />
                                    <div className="text-xs">
                                        <span className="block text-[#95aac9] dark:text-[#a7a6a8]">Servicio de Telemetría:</span>
                                        <span className="flex items-center gap-1 font-medium">
                                            {user?.has_telemetry ? (
                                                <>
                                                    <CheckCircle2 className="h-3.5 w-3.5 text-emerald-500" />
                        ...
                        {isAdmin && (
                            <div className="mt-6 border-t border-gray-100 pt-6 dark:border-gray-800/50">
                                <h3 className="text-xs font-semibold uppercase tracking-wider text-[#95aac9] dark:text-[#a7a6a8]">
                                    Accesos Rápidos de Administración
                                </h3>
                                <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-3">
                                    <Link
                                        href="/admin/users"
                                        className="group flex items-center justify-between rounded-xl border border-gray-100 bg-gray-50/50 p-4 transition-all hover:border-gray-200 hover:bg-gray-50 dark:border-gray-800/40 dark:bg-[#181b1f] dark:hover:border-gray-700/60 dark:hover:bg-[#1e2228]"
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="text-sm font-semibold text-[#293951] dark:text-white">
                                                    Gestión de Usuarios
                                                </div>
                                        ...
                                        <ArrowRight className="h-4 w-4 text-[#95aac9] transition-transform group-hover:translate-x-1 dark:text-[#a7a6a8]" />
                                    </Link>
