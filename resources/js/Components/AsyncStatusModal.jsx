                ...
                {status === 'error' && (
                    <div className="flex flex-col items-center justify-center space-y-3 py-2">
                        ...
                        <button
                            type="button"
                            onClick={onClose}
                            className="mt-3 inline-flex rounded-xl bg-[#ebf1f7] px-4 py-2 text-xs font-semibold text-[#293951] hover:bg-[#dfe7ef] dark:bg-[#16191c] dark:text-white dark:hover:bg-[#282d35]"
                        >
                            Entendido
                        </button>
                    </div>
